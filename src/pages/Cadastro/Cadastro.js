...
function Cadastro() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Plano escolhido:
        <button type="button" style={{ backgroundColor: planoEscolhido === 'gratuito' ? 'green' : 'white' }} onClick={() => setPlanoEscolhido('gratuito')}>
          Gratuito
        </button>
        <button type="button" style={{ backgroundColor: planoEscolhido === 'premium' ? 'yellow' : 'white' }} onClick={() => setPlanoEscolhido('premium')}>
          Premium
        </button>
      </label>
